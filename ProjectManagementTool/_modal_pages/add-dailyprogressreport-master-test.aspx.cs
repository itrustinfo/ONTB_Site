...
{
    public partial class add_dailyprogressreport_master_test : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = getdata.GetDailyProgressReport_by_UID(new Guid(Meeting_UID));
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CDate1.Date <= DateTime.Today.Date )
                    cnt = getdata.InsertorUpdateGFCStatusMaster(Meeting_UID, txtdesc.Text, CDate1);
