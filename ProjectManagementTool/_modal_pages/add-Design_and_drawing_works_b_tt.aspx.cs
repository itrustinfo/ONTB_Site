...
{
    public partial class add_Design_and_drawing_works_b_tt : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = getdata.Getdesignanddrawingworksbttmaster();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int cnt = getdata.InsertorUpdateDesignanddrawingworksbtt(Guid.NewGuid(), new Guid(DDLDailyReportMaster.SelectedValue), projectUid, workPackageUid, ddlZoneName.SelectedValue.ToString(), txtVillageName.Text, txtCrossing.Text,
