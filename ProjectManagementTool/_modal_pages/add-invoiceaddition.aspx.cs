...
{
    public partial class add_invoiceaddition : System.Web.UI.Page
    {
        ...
        private void BindAdditions()
        {
            DataSet ds = getdata.GetAdditionInvoiceMaster();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                Guid Invoice_AdditionUID;
                if (Request.QueryString["Invoice_AdditionUID"] != null)
                {
                    Invoice_AdditionUID = new Guid(Request.QueryString["Invoice_AdditionUID"]);
                }
                else
                {
                    Invoice_AdditionUID = Guid.NewGuid();
                }
                ...
                {
                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Invoice Addition already exists for the invoice : " + DDLInvoiceMaster.SelectedItem.Text + "');</script>");
                }
