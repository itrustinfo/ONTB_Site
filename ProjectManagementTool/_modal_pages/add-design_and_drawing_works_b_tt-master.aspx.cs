...
{
    public partial class add_design_and_drawing_works_b_tt_master : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = getdata.Getdesignanddrawingworksbttmaster_by_UID(new Guid(Meeting_UID));
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int cntDesc = getdata.Checkdesignanddrawingworksbttmaster(CDate1);
                if ((cntDesc == 1 && Request.QueryString["MeetigUID"] != null) || cntDesc == 0)                    
                {
                    ...
                    int cnt = getdata.InsertorUpdatedesignanddrawingworksbttmaster(Meeting_UID, txtdesc.Text, CDate1);
                    if (cnt > 0)
                    {
                        Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>parent.location.href=parent.location.href;</script>");
                    }
