<%@ Page Language="C#" MasterPageFile="~/_master_pages/modal.Master" AutoEventWireup="true" CodeBehind="upload-invoice-document.aspx.cs" Inherits="ProjectManagementTool._modal_pages.upload_invoice_document" %>
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <asp:GridView ID="GrdTreeView" runat="server" AutoGenerateColumns="False" PageSize="20" OnRowDeleting="GrdTreeView_RowDeleting"
                            AllowPaging="True" CssClass="table table-bordered" EmptyDataText="No Data Found." DataKeyNames="InvoiceUID" 
                            Width="100%">
                            <Columns>
                                <asp:TemplateField HeaderText="File Name">
                                    <ItemTemplate>      
                                        <%# GetOriginalFileName(Eval("FileName")) %>
