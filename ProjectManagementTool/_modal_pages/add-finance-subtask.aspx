<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/modal.Master" AutoEventWireup="true" CodeBehind="add-finance-subtask.aspx.cs" Inherits="ProjectManagementTool._modal_pages.add_finance_subtask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="modal_master_body" runat="server">
    <form id="frmAddFinanceSubTaskModal" runat="server">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="DDLWorkPackage">Work Package</label>
                         <asp:DropDownList ID="DDLWorkPackage" CssClass="form-control" runat="server" AutoPostBack="true"></asp:DropDownList>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="txtBasicBudget">Basic Budget</label>
                         <input type="text" id="txtBasicBudget" runat="server" class="form-control" onkeyup="javascript:sum();" onblur="toUSD(this)" required />

                    </div>
                   <div class="form-group">
                        <label class="lblCss" for="txtGST">GST</label>
                        
                        <input type="text" id="txtGST" runat="server" class="form-control" onkeyup="javascript:sum();" onblur="toUSD(this)" required />
                    </div>
                    <div class="form-group">
                        <label class="lblCss" for="txtBudget">Total Budget</label>
                        <input type="text" id="txtBudget" runat="server" class="form-control" onblur="toUSD(this)" required />
                        
                        
                    </div>
                     <div class="form-group">
                        <label class="lblCss" for="txtActualExpenditure">Actual Expenditure</label>
                         <input type="text" id="txtActualExpenditure" runat="server" class="form-control" onblur="toUSD(this)" required />
