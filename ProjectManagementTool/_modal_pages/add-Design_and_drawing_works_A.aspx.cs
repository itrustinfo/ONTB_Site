...
{
    public partial class add_Design_and_drawing_works_A : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = getdata.GetdesignanddrawingAmaster();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int cnt = getdata.InsertorUpdateDesignanddrawingworksA(Guid.NewGuid(), new Guid(DDLDailyReportMaster.SelectedValue), projectUid, workPackageUid, txtHeading.Text, txtSubHeading.Text, txtUnits.Text,
                      txtSiteWorks.Text, DateTime.Now);
                if (cnt > 0)
                {
