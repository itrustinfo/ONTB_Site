...
namespace ProjectManagementTool._content_pages.report_daily_progress_test
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void BindDocumentSummary()
        {
            ...
            GrdDocumentSummary.DataSource = null;

            DataSet ds = new DataSet();

            ds = getdt.GetGFCStatusReport1(DPR_UID, projectUid, workPackageUid);
            ...
            if(ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                DocumentSummaryReportName.InnerHtml = "Report Name : GFC Status Report";
        ...
        protected void btnDocumentSummaryExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl1' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Design & Drawings Works B STP Report</asp:Label><br />" +
