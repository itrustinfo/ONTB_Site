        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    {
                        BtnAddWorkpackagemaster.Visible = false;
                        Button1.Visible = false;
                        Button2.Visible = false;
                        //
                        grdMasters.Columns[3].Visible = false;
                        grdMasters.Columns[4].Visible = false;
                        //
                        GrdLocationMaster.Columns[3].Visible = false;
                        GrdLocationMaster.Columns[4].Visible = false;
                        //
                        GrdClient.Columns[3].Visible = false;
                        GrdClient.Columns[4].Visible = false;
                    }
                }
            }
        }
