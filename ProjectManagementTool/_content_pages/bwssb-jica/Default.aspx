<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ProjectManagementTool._content_pages.bwssb_jica.Default" %>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                              <h6 class="text-muted">
                                   <asp:Label ID="ActivityHeading" CssClass="text-uppercase font-weight-bold" runat="server" Text="Status of BWSSB Payment vs JICA Disbursement" />
                        ...
                        <div class="table-responsive">
                              <div>
                                  <asp:HiddenField ID="ReviewMeetingDate" runat="server" />
                                   <a id="AddBankGuarantee" runat="server" href="~/_modal_pages/add-bwssb-jica-disbursement.aspx" class="showBankGuaranteeModal"><asp:Button ID="Button2" runat="server" Text="+ Add" CssClass="btn btn-primary"></asp:Button></a>
                                </div><br />
                                ...
                                <Columns>
                                      <asp:TemplateField>
                                        <ItemTemplate>
                                            <a id="Edit" href="/_modal_pages//add-bwssb-jica-disbursement.aspx?UID=<%#Eval("UID")%>&type=edit" class="showBankGuaranteeModal"><span title="Edit" class="fas fa-edit"></span></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <HeaderStyle HorizontalAlign="Left" />
                                  ...
                                  <%--   <asp:BoundField DataField="Payment_Year" HeaderText="Payment_Year" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>--%>
                                     <asp:BoundField DataField="Q1_Payment_Amount" HeaderText="Q1" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                                    <asp:BoundField DataField="Q2_Payment_Amount" HeaderText="Q2" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                                    <asp:BoundField DataField="Q3_Payment_Amount" HeaderText="Q3" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                                    <asp:BoundField DataField="Q4_Payment_Amount" HeaderText="Q4" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
	    ...
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
		    <div class="modal-content">
			    <div class="modal-header">
				    <h5 class="modal-title">Add BWSSB vs JICA Disbursement</h5>
