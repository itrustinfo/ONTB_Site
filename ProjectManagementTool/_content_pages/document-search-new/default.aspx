<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.document_search_new._default" %>
    ...
    <script type="text/javascript">
        ...
        function getDataS() {
            ...
            var getvalue = value.options[value.selectedIndex].value;  
             var value1 = document.getElementById("<%=DDLWorkPackage.ClientID%>");  
           ...
           // alert("value:-" +" "+ getvalue + " "+ "Text:-" +" "+ gettext);  
             PageMethods.getData(getvalue,getvalue1,OnSuccess);
        }

        function OnSuccess(response) {
           // alert(response);
                  document.getElementById("divClientsSideDiv").innerHTML = response;
...
document.getElementById('DivFooterRowNew').scrollLeft = Scrollablediv.scrollLeft;
      ...
      dateFormat:'dd/mm/yy'
        ...
        function hideGrid() {
          //  document.getElementById("GrdDocuments").style.display = "none";
             document.getElementById('GrdDocuments').style.visibility = 'hidden';
        }
        ...
        function Reload() {
            ...
            var gettype = type.options[type.selectedIndex].value;
             var status = document.getElementById("<%=ddlstatus.ClientID%>");  
            var getstatus = status.options[status.selectedIndex].value;

            window.location.href = "/_content_pages/document-search-new/default.aspx" + "?PrjUID=" + getvalue + "&WPkgUID=" + getvalue1 + "&Sub=" + document.getElementById("txtSubmittal").value + "&Doc=" + document.getElementById("txtDocName").value + "&type=" + gettype + "&status=" + getstatus + "&Indate=" + document.getElementById("dtInDate").value + "&Intodate=" + document.getElementById("dtInToDate").value + "&DocDate=" + document.getElementById("dtDocDate").value + "&DocToDate=" + document.getElementById("dtDocToDate").value + "&Page=" + document.getElementById("txtPageSize").value;
        }
        ...
        function CallSelectedIndexChanged() {
            ...
            var value = document.getElementById("<%=DDlProject.ClientID%>");  
            var getvalue = value.options[value.selectedIndex].value;  
            window.location.href = "/_content_pages/document-search-new/default.aspx" + "?loadWkpckg=true&PrjectUID=" + getvalue;
        }
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="DDlProject" runat="server" CssClass="form-control" AutoPostBack="false" OnSelectedIndexChanged="DDlProject_SelectedIndexChanged" onchange="CallSelectedIndexChanged();" ClientIDMode="Static"></asp:DropDownList>
                        <%--View document modal--%>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 form-group" id="divWP"  runat="server">
                    ...
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="DDLWorkPackage" runat="server" CssClass="form-control" AutoPostBack="false" OnSelectedIndexChanged="DDLWorkPackage_SelectedIndexChanged" ClientIDMode="Static"></asp:DropDownList>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" id="divMain" runat="server">
                             <table class="table table-borderless" style="border:1px solid #909090;">
                                 <tr style="font-weight:bold;"><td>Submittal Name : <asp:TextBox runat="server" ID="txtSubmittal" CssClass="form-control" ClientIDMode="Static"></asp:TextBox></td><td>Document Name : <asp:TextBox runat="server" ID="txtDocName" CssClass="form-control" ClientIDMode="Static"></asp:TextBox></td><td>Document Type<asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" ClientIDMode="Static">
                                        
                                     </asp:DropDownList>
                                     </td><td>Status<asp:DropDownList ID="ddlstatus" runat="server" CssClass="form-control" ClientIDMode="Static">
                                 ...
                                 <tr>
                                     ...
                                     <asp:TextBox ID="txtPageSize" runat="server" Width="30px" ClientIDMode="Static">10</asp:TextBox></td>
                                     <td colspan="2" style="text-align:center">
                                        <input id="Button1" type="button" value="Client Side event" onclick="getDataS();" class="btn btn-primary"/>
                                         <input id="Button2" type="button" value="Reload on Client Side" onclick="Reload();" class="btn btn-primary"/>
                                     <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btnSubmit_Click1" OnClientClick="hideGrid();"/>&nbsp;&nbsp;&nbsp;
                         ...
                         <asp:GridView ID="GrdDocuments" EmptyDataText="No Documents Found." runat="server" Width="100%" AutoGenerateColumns="false" 
                                            AllowPaging="true" AllowSorting="True" PageSize="10" DataKeyNames="ActualDocumentUID" CssClass="table table-bordered" OnRowDataBound="GrdDocuments_RowDataBound" OnPageIndexChanging="GrdDocuments_PageIndexChanging" OnRowCommand="GrdDocuments_RowCommand" OnSorting="GrdDocuments_Sorting" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="White" AlternatingRowStyle-BackColor="#F5F5F5" OnDataBound="GrdDocuments_DataBound" ClientIDMode="Static">
                                       <Columns>
