...
namespace ProjectManagementTool._content_pages.report_design_and_drawing_works_b_tt
{
        ...
        protected void BindDocumentSummary()
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
              ...
              //  btnDocumentSummaryPrint.Visible = true;
                ...
                DocumentSummaryReportName.InnerHtml = "Report Name : Design and Drawing Works B TT Report";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sHTMLString += "<td style='width:18%'><b>Village Name</b></td>";
                    sHTMLString += "<td style='width:15%'><b>Crossing</b> </td>";
                    sHTMLString += "<td style='width:15%'><b>GFC Status</b></td>";
                    sHTMLString += "<td style='width:12%'><b>Length m</b></td>";
                    sHTMLString += "<td style='width:12%'><b>Diameter mm</b></td>";
                    sHTMLString += "<td style='width:12%'><b>Start Depth m</b> </td>";
                    sHTMLString += "<td style='width:12%'><b>Stop Depth m</b></td></tr>";
                    ...
                    foreach (var bommanahalli in bommanahalliList)
                    {
                        ...
                        sHTMLString += "<td>" + bommanahalli["VillageName"].ToString() + "</td>";
                        sHTMLString += "<td>" + bommanahalli["Crossing"].ToString() + "</td>";
                        sHTMLString += "<td>" + bommanahalli["GFCStatus"].ToString() + "</td>";
                        sHTMLString += "<td>" + bommanahalli["Length"].ToString() + "</td>";
                        sHTMLString += "<td>" + bommanahalli["DiaMeter"].ToString() + "</td>";
                        sHTMLString += "<td>" + bommanahalli["StartDepth"].ToString() + "</td>";
                        sHTMLString += "<td>" + bommanahalli["StopDepth"].ToString() + "</td>";
                        sHTMLString += "</tr>";
                    }

                    var mahadevapuraList = ds.Tables[0].AsEnumerable().Where(r => r.Field<string>("ZoneName") == "Mahadevapura").ToList();
                    sHTMLString += "<tr><td colspan='8' style='text-align:center;width:100%'>Mahadevapura</td></tr>";
                     i = 0;
                    foreach (var mahadevapura in mahadevapuraList)
                    {
                        i += 1;
                        sHTMLString += "<tr><td>" + (i) + "</td>";
                        sHTMLString += "<td>" + mahadevapura["VillageName"].ToString() + "</td>";
                        sHTMLString += "<td>" + mahadevapura["Crossing"].ToString() + "</td>";
                        sHTMLString += "<td>" + mahadevapura["GFCStatus"].ToString() + "</td>";
                        sHTMLString += "<td>" + mahadevapura["Length"].ToString() + "</td>";
                        sHTMLString += "<td>" + mahadevapura["DiaMeter"].ToString() + "</td>";
                        sHTMLString += "<td>" + mahadevapura["StartDepth"].ToString() + "</td>";
                        sHTMLString += "<td>" + mahadevapura["StopDepth"].ToString() + "</td>";
                        sHTMLString += "</tr>";
                    }
