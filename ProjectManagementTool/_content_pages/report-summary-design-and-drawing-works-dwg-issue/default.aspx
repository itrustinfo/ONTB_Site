<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.report_summary_design_and_drawing_works_dwg_issue._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-lg-3 form-group">GFC Status Report</div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="col-lg-12 col-xl-12 form-group" align="center">
                            <h5 id="DocumentSummaryReportName" style="font-weight: bold;" runat="server">GFC Status as on </h5>
                        ...
                        <div class="table-responsive"  id="DivAcrossMonths" runat="server">
                            <asp:GridView ID="GrdDocumentSummary" EmptyDataText="No Documents Found." HeaderStyle-HorizontalAlign="Right" runat="server" Width="100%" AutoGenerateColumns="false" 
                                                     
                                OnDataBound="GrdDocumentSummary_DataBound"
                                OnRowDataBound="GrdDocumentSummary_RowDataBound" AllowPaging="false" CssClass="table table-bordered" ShowFooter="true">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Package" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="text-left">
                                        <ItemTemplate>
                                            <%#Eval("PackageName")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Scope" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%#Eval("Score_in_kms")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Length in KM" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%#Eval("Length")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="GFC Released by ONTB" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%#Eval("GFCReleased")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Balance GFC to be released by ONTB" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%#Eval("BalanceGFC")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="GFC Approved" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%#Eval("GFCApproved")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
