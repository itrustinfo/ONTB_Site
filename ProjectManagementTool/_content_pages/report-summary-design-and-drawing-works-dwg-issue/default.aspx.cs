...
namespace ProjectManagementTool._content_pages.report_summary_design_and_drawing_works_dwg_issue
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        //{
        //    DataSet ds = getdt.GetdesignanddrawingDWGIssuemaster();
        ...
        protected void BindDocumentSummary()
        {
            ...
            DataSet ds = new DataSet();
            ds = getdt.GetSummarydesignanddrawingworksdwgIssue(workPackageUid);
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
              ...
              //  btnDocumentSummaryPrint.Visible = true;
                ...
                DocumentSummaryReportName.InnerHtml = "Report Name : GFC Status Report as on" + DateTime.Today.ToString("dd/MM/yyyy");
              ...
              //  DataTable dt = ds.Tables[0].Copy();
                ...
                GrdDocumentSummary.DataSource = ds;
                GrdDocumentSummary.DataBind();

                decimal total_scrore_in_kms = ds.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("Score_in_kms"));
                GrdDocumentSummary.FooterRow.Cells[1].Text = "Summary";
                GrdDocumentSummary.FooterRow.Cells[1].HorizontalAlign = HorizontalAlign.Right;

                GrdDocumentSummary.FooterRow.Cells[2].HorizontalAlign = HorizontalAlign.Right;
                GrdDocumentSummary.FooterRow.Cells[2].Text = total_scrore_in_kms.ToString("N2");

                decimal total_Length = ds.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("Length"));
                GrdDocumentSummary.FooterRow.Cells[3].HorizontalAlign = HorizontalAlign.Right;
                GrdDocumentSummary.FooterRow.Cells[3].Text = total_Length.ToString("N2");

                decimal total_gfc_released = ds.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("GFCReleased"));
                GrdDocumentSummary.FooterRow.Cells[4].HorizontalAlign = HorizontalAlign.Right;
                GrdDocumentSummary.FooterRow.Cells[4].Text = total_gfc_released.ToString("N2");

                decimal total_balance_gfc = ds.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("BalanceGFC"));
                GrdDocumentSummary.FooterRow.Cells[5].HorizontalAlign = HorizontalAlign.Right;
                GrdDocumentSummary.FooterRow.Cells[5].Text = total_balance_gfc.ToString("N2");

                decimal total_gfc_approved = ds.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("GFCApproved"));
                GrdDocumentSummary.FooterRow.Cells[6].HorizontalAlign = HorizontalAlign.Right;
                GrdDocumentSummary.FooterRow.Cells[6].Text = total_balance_gfc.ToString("N2");
                ...
                //    sHTMLString += "<tr><td style='width:4%;text-align:center;' colspan='4'><b>Bommanahalli</b></td>";
                //    sHTMLString += "<tr><td style='width:4%'><b>Sl No</b></td>";
                //    sHTMLString += "<td style='width:18%'><b>Location</b></td>";
                //    sHTMLString += "<td style='width:15%'><b>Length in Km</b> </td>";
                //    sHTMLString += "<td style='width:15%'><b>Date</b></td></tr>";


                //    var bommanahalliList = ds.Tables[0].AsEnumerable().Where(r => r.Field<string>("ZoneName") == "Bommanahalli").ToList();
                ////    sHTMLString += "<tr><td colspan='8' style='text-align:center;width:100%'>Bommanhalli</td></tr>";
                //    int i = 0;
                //    foreach (var bommanahalli in bommanahalliList)
                //    {
                //        i += 1;
                //        sHTMLString += "<tr><td>"+(i)+"</td>";
                //        sHTMLString += "<td>" + bommanahalli["Location"].ToString() + "</td>";
                //        sHTMLString += "<td>" + bommanahalli["submittedbycontrator"].ToString() + "</td>";
                //        sHTMLString += "<td>" + Convert.ToDateTime(bommanahalli["SubmittedDate"].ToString()).ToString("dd/MM/yyyy") + "</td>";

                //        sHTMLString += "</tr>";
                //    }
                //    sHTMLString += "</table></div>";

                //    sHTMLString += " <div style = 'width:100%; float:left;  overflow-y:auto;'><table class='table table-bordered'>";
                //    sHTMLString += "<tr><td style='width:4%;text-align:center;' colspan='4'><b>Mahadevapura</b></td>";
                //    sHTMLString += "<tr><td style='width:4%'><b>Sl No</b></td>";
                //    sHTMLString += "<td style='width:18%'><b>Location</b></td>";
                //    sHTMLString += "<td style='width:15%'><b>Length in Km</b> </td>";
                //    sHTMLString += "<td style='width:15%'><b>Date</b></td></tr>";
                //    var mahadevapuraList = ds.Tables[0].AsEnumerable().Where(r => r.Field<string>("ZoneName") == "Mahadevapura").ToList();
                // //   sHTMLString += "<tr><td colspan='4' style='text-align:center;width:100%'>Mahadevapura</td></tr>";
                //     i = 0;
                //    foreach (var mahadevapura in mahadevapuraList)
                //    {
                //        i += 1;
                //        sHTMLString += "<tr><td>" + (i) + "</td>";
                //        sHTMLString += "<td>" + mahadevapura["Location"].ToString() + "</td>";
                //        sHTMLString += "<td>" + mahadevapura["submittedbycontrator"].ToString() + "</td>";
                //        sHTMLString += "<td>" +Convert.ToDateTime( mahadevapura["SubmittedDate"].ToString()).ToString("dd/MM/yyyy") + "</td>";
                //        sHTMLString += "</tr>";
                //    }
                //    sHTMLString += "</table></div>";
