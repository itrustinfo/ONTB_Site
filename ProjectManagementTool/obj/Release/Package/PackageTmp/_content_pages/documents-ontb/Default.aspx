<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ProjectManager._content_pages.documents_ontb.Default" %>
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-4 form-group">Documents</div>
             <div class="col-md-6 col-lg-3 form-group">
                    ...
                    <label class="sr-only" for="DDLProject" style="visibility:hidden">Project</label>
                    <div class="input-group">
                        <div class="input-group-prepend" >
                            <span class="input-group-text" style="visibility:hidden">Project</span>
                        </div>
                        <asp:DropDownList ID="DDlProject" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDlProject_SelectedIndexChanged" visible="false"></asp:DropDownList>
          ...
          <div class="col-lg-6 col-xl-12 form-group">
                        <div class="card">
                            <div class="card-body" style="padding-bottom:0; margin-bottom:0;">
                                <div class="row">
                         <div class="col-lg-2">
                            <h6 class="card-title text-muted text-uppercase font-weight-bold">General Documents View</h6>
    ...
    <div id="ModDocumentPreview" class="modal it-modal fade">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
		    <div class="modal-content">
			    ...
			    <div class="modal-body">
                    <iframe class="border-0 w-100" style="height:700px;" loading="lazy"></iframe>
			    </div>
