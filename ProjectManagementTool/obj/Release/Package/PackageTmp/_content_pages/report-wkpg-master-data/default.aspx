<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.report_wkpg_master_data._default" %>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                              <h6 class="text-muted">
                                   <asp:Label ID="lblDocumentsNo" CssClass="text-uppercase font-weight-bold" runat="server" Text="WorkPackage Master Data Update Report" Visible="true" />
                        ...
                        <asp:GridView ID="grdDataList" EmptyDataText="No Data Found." runat="server" Width="100%" AutoGenerateColumns="false" CellPadding="6" CellSpacing="16" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="White" AlternatingRowStyle-BackColor="#F5F5F5" 
                                       ...
                                       <Columns>
                                             <asp:BoundField DataField="ProjectUID" HeaderText="ProjectUID">
                                          ...
                                          <asp:BoundField DataField="ProjectName" HeaderText="Project Name">
                                           ...
                                           <asp:BoundField DataField="ActualExpenditure" HeaderText="ActualExpenditure">
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                           ...
                                           <asp:BoundField DataField="Frequency" HeaderText="Update Frequency">
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                       </Columns>
                                       </asp:GridView>
