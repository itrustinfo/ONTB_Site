<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" MaintainScrollPositionOnPostBack="true" CodeBehind="Default.aspx.cs" Inherits="ProjectManager._content_pages.engineering_fast_view.Default" %>
   ...
   <%-- <div class="container-fluid">
    ...
    <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-4 form-group">Engineering Activities</div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                              <h6 class="text-muted">
                                   <asp:Label ID="Label2" Text="Option" CssClass="text-uppercase font-weight-bold" runat="server" />
                               </h6>
                                <div>
