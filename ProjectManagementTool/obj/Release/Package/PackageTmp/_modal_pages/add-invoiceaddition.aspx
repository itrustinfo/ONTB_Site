<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/modal.Master" AutoEventWireup="true" CodeBehind="add-invoiceaddition.aspx.cs" Inherits="ProjectManagementTool._modal_pages.add_invoiceaddition" %>
        ...
        <div class="container-fluid" style="max-height:80vh; overflow-y:auto;">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="DDLDeduction">Addition</label> &nbsp;<span style="color:red; font-size:1.1rem;">*</span>
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="txtbudget">Addition Mode</label> &nbsp;<span style="color:red; font-size:1.1rem;">*</span>
